...
//            qDebug()<<corners[i].x<<corners[i].y;
//            cv::circle(temp,corners[i],3,cv::Scalar(0,0,255),2,8,0);
//            cv::imshow("temp"+QString::number(i).toStdString(),temp);
    ...
    //        // Warp the current image mask
            ...
            //cv::imshow("123",mask_warped);
            //cv::waitKey(0);

//            cv::imshow("warp ",images_warped);
//            cv::imshow("mask ",masks_warped);
